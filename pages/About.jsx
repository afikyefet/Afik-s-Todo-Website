...
export function About() {
    ...
    return (
        <section className="about">
            ...
            <p>Lorem tet ipsum dolor sit amet consectetur, adipisicing elit. Optio dolore sapiente, iste animi corporis nisi atque tempora assumenda dolores. Nobis nam dolorem rerum illo facilis nemo sit voluptatibus laboriosam necessitatibus!</p>
            <button onClick={() => {
